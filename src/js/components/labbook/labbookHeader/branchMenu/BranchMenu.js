...
class BranchMenu extends Component {
  ...
  */
  _closeMenu(evt) {
    ...
    let isBranchMenu = (evt.target.className.indexOf('BranchMenu') > -1) || (evt.target.className.indexOf('CollaboratorsModal') > -1) || (evt.target.className.indexOf('BranchMenu__message') > -1) ||
  ...
  render() {
    ...
    return (
      <div className="BranchMenu flex flex--column'">
        ...
        <div className={branchMenuArrowCSS}></div>
...

            {
              ...
              <div>
                ...
                <div className="BranchMenu__copyRemote">
                  ...
                  <button onClick={()=> this._copyRemote()} className="BranchMenu__btn--copy fa fa-clone"></button>
